	  ...
	  <div class="modal-dialog" role="document">
					...
					$http.post('../helper/get_all_files.php', 
					   	...
					   	}).then(function (response) 
					   	{
							...
							if(response.data.length == 0)
								$('#no_files_prompt').show();
							else
							{
								$('#no_files_prompt').hide();
					...
					$http.post('../helper/find_file.php', 
					   	...
					   	}).then(function (response) 
					   	{
						   	...
						   	if(response.data == false)
						   	{
							 	...
							 	$('#alert_error').html("No documents were found for your search <i><b>" + $scope.file_to_search + "</b></i>");
							 	$('#alert_error').show();
		...
		<div id="outer_box">
				...
				<ul id="left_nav_list">
					...
					<li><span class="fa fa-book"></span> <?php echo $_SESSION['company_name']; ?></li>
					<li><span id="signout" ng-click="logout()"><span class="fa fa-sign-out"></span> Sign out</span></li>
					<!-- 
					<li><span style="cursor:pointer;" onclick="location = 'atb'"><span class="fa fa-book"></span> ATB</li>
					...
					<li style="cursor:pointer;" onclick="location='scotiabank'"><span class="fa fa-book"></span> SCOTIABANK</li>
					<li><span class="fa fa-book"></span> TD</li>
					<li style="margin-left:-30px;padding:10px 10px 10px 30px;background:#ddd;color:#444;cursor:pointer;"><span class="fa fa-book"></span> My Account</li>
				...
				<div align="center" style="display:table-cell;text-align:left;height:100%;padding-left:210px;padding-bottom:50px;padding-top:60px;padding-right:10px;">
					...
					<?php if($_SESSION['user_email'] == "admin@email.com")
						...
						<div style="display:table-cell;">
							<textarea id="admin_description" placeholder="Write here..." style="font-size:14px;margin-right:10px;margin-top:10px;padding:10px;width:500px;height:200px;margin-bottom:10px;"></textarea>
						...
						<div style="display:table-cell;vertical-align:top;padding-top:10px;">
							...
							<div>
							<div class="alert alert-warning" id="alert_admin_content" style="display: none;width:500px;"></div>	
						...
						<div id="how_to_use_app" style="display:none;">
							<div  class="alert alert-success" style="background:#27848e;color:#eee;margin-top:10px;width:50%;">How to use the App<span style="cursor:pointer;" onclick="$('#how_to_use_app').hide()"><span class="pull-right fa fa-times-circle" style="margin-top:5px;"></span><span class="pull-right">Close</span></span></div>	
	
							<div  class="alert alert-warning" id="admin_content" ng-init="get_admin_content()" style="background:#fff;margin-top:10px;width:50%;border:1px solid #aaa;color:#777"></div>	
						</div>
					...
					<div style="margin-top:10px;background:#27848e;border:none;color:#eee;" class="alert alert-primary"><span class="fa fa-book"></span> My Documents</span><span onclick="location.reload()" style="cursor:pointer;" class="pull-right">See all my Files</span></div>
					
					<span id="no_files_prompt" style="display:none;">Upload some PDF Documents to see them here.</span>
					...
					<div ng-init="get_user_files('<?php echo $_SESSION['user_email']; ?>')">
						<div ng-repeat="d in all_files">
							...
							<span ng-click='delete_file(d.user_email,d.file_name)' class='file_action'>Delete <span style="color:#27848e;" ng-model="delete_file_name" ng-bind="d.file_name"></span></span>
